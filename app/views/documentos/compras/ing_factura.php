            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls col-sm-4">
                            <input type='date' class="form-control" name='txtFecha' value='<?=set_value("txtNumero")?>' />
                        </div>
                        <label class="control-label col-sm-1">*</label>
                        <div class="controls col-sm-5">
                            <?php 
                    ...
                    <p class="text-center">
                        ...
                        <button type='submit' value='Modificar' class="btn btn-outline btn-primary btn-lg" data-loading-text="Loading...">Siguiente</button> 
